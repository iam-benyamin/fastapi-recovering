...
from schema._input import LoginInput, RegisterInput, UpdateProfileInput
...
async def delete_user(
    ...
    await UsersOperations(db_session).user_delete_account(username=token_data.username)
